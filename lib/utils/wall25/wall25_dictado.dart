...
import 'package:sunboards_vuit/utils/wall25/button25_dictado.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return GridView.builder(
      ...
      itemBuilder: (context,index ) {
        ...
        return Container( color: Colors.transparent,child: Wall25ButtonDictado(index: int.parse(num25[index]), sendMessage: sendMessage));
      },
      itemCount:570,
    );
