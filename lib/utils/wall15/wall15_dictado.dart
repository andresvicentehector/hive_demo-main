...
import 'package:sunboards_vuit/utils/wall15/button15_dictado.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return GridView.builder(
      ...
      itemBuilder: (context,index ) {
        ...
        return Container( color: Colors.transparent,child: Wall15ButtonDictado(index: int.parse(num15[index]), sendMessage: sendMessage));
      },
      itemCount: 384,
    );
